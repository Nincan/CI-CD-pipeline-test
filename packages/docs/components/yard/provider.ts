...
export const getActiveTheme = (values: { [key: string]: string }, initialValues: { [key: string]: string }) => {
...
export const getThemeDiff = (values: { [key: string]: string }, initialValues: { [key: string]: string }) => {
...
export const getProvider = (initialThemeValues: { [key: string]: string }, themePrimitives: string): TProvider => {
  return {
    value: undefined,
    ...
    generate: (value: TProviderValue, childTree: t.JSXElement) => generate(value, childTree, themePrimitives),
    imports: {
      baseui: {
