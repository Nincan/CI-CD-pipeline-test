...
import { Menu, MenuItem, MenuRef } from 'spaceweb/menu';
...
const RefNavigation = () => {
  const [menuRef, setMenuRef] = useState<MenuRef | null>(null);
  return (
    <Box>
      <Search onFocus={menuRef?.turnOnKeyboardNavigation} onBlur={menuRef?.turnOffKeyboardNavigation} />
