...
export default () => (
  <Grid cols={3} rowGap={2} colGap={2} className="w-3/4">
    ...
    {ICON_BUTTON_SHAPES.map((shape: Shape) => (
      <Col key={shape}>
        <IconButton aria-label={`${shape} Icon Button`} shape={shape}>
          <LightBulbIcon />
        </IconButton>
      </Col>
    ))}
    ...
    {ICON_BUTTON_SHAPES.map((shape: Shape) => (
      <Col key={shape}>
        <IconButton aria-label={`${shape} disabled Icon Button`} shape={shape} disabled>
          <LightBulbIcon />
        </IconButton>
      </Col>
    ))}
    ...
    {ICON_BUTTON_SHAPES.map((shape: Shape) => (
      <Col key={shape}>
        <IconButton aria-label={`${shape} loaging Icon Button`} shape={shape} isLoading>
          <LightBulbIcon />
        </IconButton>
      </Col>
    ))}
    ...
    {ICON_BUTTON_SHAPES.map((shape: Shape) => (
      <Col key={shape}>
        <IconButton aria-label={`${shape} selected Icon Button`} shape={shape} isSelected>
          <LightBulbIcon />
        </IconButton>
      </Col>
    ))}
