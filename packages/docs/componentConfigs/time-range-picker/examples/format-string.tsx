...
export default (): ReactElement => {
  const [formatString, setFormatString] = React.useState<Value>([]);
    ...
    <Grid cols={2} gap={4}>
      <Col>
        <Select
          ...
          valueKey="label"
          onChange={({ value: _value }): void => setFormatString(_value)}
          value={formatString}
        />
      </Col>
      <Col>
        <TimeRangePicker
          formatString={formatString[0]?.id as FormatString | undefined}
          value={value}
          timezone={timezone}
