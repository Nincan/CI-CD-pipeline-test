export default [
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-hover',
        values: ['borderColor: var(--spr-hover, #0729a0)'],
      },
      {
        selector: '.spr-focus-01',
        values: ['borderColor: var(--spr-focus-01, #0E61F6)'],
      },
      {
        selector: '.spr-border-01',
        values: ['borderColor: var(--spr-border-01, #EEEEEE)'],
      },
      {
        selector: '.spr-border-02',
        values: ['borderColor: var(--spr-border-02, #E6E6E9)'],
      },
      {
        selector: '.spr-border-03',
        values: ['borderColor: var(--spr-border-03, #DBDBDB)'],
      },
      {
        selector: '.spr-border-04',
        values: ['borderColor: var(--spr-border-04, #818192)'],
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-link',
        values: ['color: var(--spr-link, #0E61F6)'],
      },
      {
      ...
      },
      {
        ...
        values: ['color: var(--spr-text-04, #0E61F6)'],
      },
      {
      ...
      },
      {
        ...
        values: ['color: var(--spr-support-error-text, #C70F5C)'],
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-ui-03',
        values: ['backgroundColor: var(--spr-ui-03, #DBDBDB)'],
      },
      {
        selector: '.spr-ui-04',
        values: ['backgroundColor: var(--spr-ui-04, #0E61F6)'],
      },
      {
        selector: '.spr-ui-05',
        values: ['backgroundColor: var(--spr-ui-05, #EEF0F1)'],
      },
      {
        selector: '.spr-ui-06',
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-ui-hover, #F8F8FA)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-support-error, #C70F5C)'],
      },
      {
        selector: '.spr-support-error-highlight',
        values: ['backgroundColor: var(--spr-support-error-highlight, rgba(199, 15, 92, 0.2))'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-support-success-highlight, rgba(106, 201, 110, 0.2))'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-support-warning-highlight, rgba(243, 191, 36, 0.2))'],
      },
      {
      ...
      {
        selector: '.spr-tag-01',
        values: ['backgroundColor: var(--spr-tag-01, #E6E6E9)'],
      },
      {
        selector: '.spr-tag-02',
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-notification, #DE336A)'],
      },
      {
        selector: '.spr-interactive-01',
        values: ['backgroundColor: var(--spr-interactive-01, #0E61F6)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-interactive-disable, rgba(255, 255, 255, 0.6))'],
      },
      {
        selector: '.spr-interactive-02',
        values: ['backgroundColor: var(--spr-interactive-02, #DBDBDB)'],
      },
      {
        selector: '.spr-clr-blue',
        values: ['backgroundColor: var(--spr-clr-blue, #2EA2FB)'],
      },
      {
        selector: '.spr-clr-green',
        values: ['backgroundColor: var(--spr-clr-green, #33CC99)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-clr-red, #E1245E)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-clr-yellow, #ECAD00)'],
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['fill: var(--spr-icon-03, #818192)'],
      },
      {
        selector: '.spr-icon-04',
        values: ['fill: var(--spr-icon-04, #0E61F6)'],
      },
      {
      ...
      },
      {
        ...
        values: ['fill: var(--spr-icon-error, #C70F5C)'],
      },
      {
      ...
      },
      {
        ...
        values: ['fill: var(--nav-icon-focus-01, #0E61F6)'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['boxShadow: var(--spr-shadow-04, -2px 5px 12px -4px rgba(10,10,20,.20))'],
      },
      {
  ...
  },
  {
    ...
    rules: [
      {
        selector: '.outline-01',
        values: ['outlineStyle: solid', 'outlineWidth: 2px', 'outlineColor: #0E61F6', 'outlineOffset: 2px'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['outline: var(--spr-focus-02, 1px solid #0E61F6)'],
      },
      {
        selector: '.spr-shadow-01',
        values: ['boxShadow: var(--spr-shadow-01, 0 1px 4px 0 rgba(10,10,20,0.15))'],
