export default [
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['borderColor: var(--spr-interactive-focus, #0A65A1)'],
      },
      {
        selector: '.spr-hover',
        values: ['borderColor: var(--spr-hover, #0AA2FF)'],
      },
      {
        selector: '.spr-focus-01',
        values: ['borderColor: var(--spr-focus-01, #4B8AFC)'],
      },
      {
        selector: '.spr-border-01',
        values: ['borderColor: var(--spr-border-01, #3A3A3E)'],
      },
      {
        selector: '.spr-border-02',
        values: ['borderColor: var(--spr-border-02, #48484C)'],
      },
      {
        selector: '.spr-border-03',
        values: ['borderColor: var(--spr-border-03, #646469)'],
      },
      {
      ...
      },
      {
        ...
        values: ['borderColor: var(--spr-border-05, #2C2C2F)'],
      },
      {
        selector: '.spr-border-06',
        values: ['borderColor: var(--spr-border-06, #F1F1F1)'],
      },
      {
        selector: '.spr-card-border',
        values: ['borderColor: var(--spr-card-border, #3A3A3E)'],
      },
      {
        selector: '.spr-popup-border',
        values: ['borderColor: var(--spr-popup-border, #1C1C1F)'],
      },
      {
        selector: '.spr-tooltip-border',
        values: ['borderColor: var(--spr-tooltip-border, rgba(174, 174, 178, 0.2))'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-link',
        values: ['color: var(--spr-link, #4B8AFC)'],
      },
      {
        selector: '.spr-text-01',
        values: ['color: var(--spr-text-01, #F1F1F1)'],
      },
      {
        selector: '.spr-text-02',
        values: ['color: var(--spr-text-02, #AEAEB2)'],
      },
      {
        selector: '.spr-text-03',
        values: ['color: var(--spr-text-03, #646469)'],
      },
      {
        selector: '.spr-text-04',
        values: ['color: var(--spr-text-04, #4B8AFC)'],
      },
      {
        selector: '.spr-text-05',
        values: ['color: var(--spr-text-05, #F1F1F1)'],
      },
      {
        selector: '.spr-text-06',
        values: ['color: var(--spr-text-06, #2C2C2F)'],
      },
      {
        selector: '.spr-text-placeholder',
        values: ['color: var(--spr-text-placeholder, #646469)'],
      },
      {
        selector: '.spr-support-error-text',
        values: ['color: var(--spr-support-error-text, #FA6274)'],
      },
      {
        selector: '.spr-support-success-text',
        values: ['color: var(--spr-support-success-text, #6AC96E)'],
      },
      {
        selector: '.spr-support-warning-text',
        values: ['color: var(--spr-support-warning-text, #F3BF24)'],
      },
      {
        selector: '.nav-text-01',
        values: ['color: var(--nav-text-01, rgba(255, 255, 255, 0.6))'],
      },
    ],
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['fontSize: 4.2rem', 'lineHeight: 4.8rem', 'fontWeight: 600'],
      },
      {
        selector: '.typography-h2',
        values: ['fontSize: 2.4rem', 'lineHeight: 2.9rem', 'fontWeight: 600'],
      },
      {
        selector: '.typography-h3',
        values: ['fontSize: 2rem', 'lineHeight: 2.6rem', 'fontWeight: 600'],
      },
      {
        selector: '.typography-h4',
        values: ['fontSize: 1.6rem', 'lineHeight: 2.4rem', 'fontWeight: 600'],
      },
      {
      ...
      },
      {
        ...
        values: ['fontSize: 1.2rem', 'lineHeight: 1.8rem', 'fontWeight: 400'],
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-ui-01',
        values: ['backgroundColor: var(--spr-ui-01, #1C1C1F)'],
      },
      {
        selector: '.spr-ui-02',
        values: ['backgroundColor: var(--spr-ui-02, #212123)'],
      },
      {
        selector: '.spr-ui-03',
        values: ['backgroundColor: var(--spr-ui-03, #48484C)'],
      },
      {
        selector: '.spr-ui-04',
        values: ['backgroundColor: var(--spr-ui-04, #4B8AFC)'],
      },
      {
        selector: '.spr-ui-05',
        values: ['backgroundColor: var(--spr-ui-05, #3A3A3E)'],
      },
      {
        selector: '.spr-ui-06',
        values: ['backgroundColor: var(--spr-ui-06, #2C2C2F)'],
      },
      {
        selector: '.spr-ui-focus',
        values: ['backgroundColor: var(--spr-ui-focus, rgba(255, 255, 255, 0.12))'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-ui-hover, #212123)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-support-error, #FA6274)'],
      },
      {
        selector: '.spr-support-error-highlight',
        values: ['backgroundColor: var(--spr-support-error-highlight, rgba(250, 98, 116, 0.3))'],
      },
      {
        selector: '.spr-support-success',
        values: ['backgroundColor: var(--spr-support-success, #6AC96E)'],
      },
      {
        selector: '.spr-support-success-highlight',
        values: ['backgroundColor: var(--spr-support-success-highlight, rgba(106, 201, 110, 0.3))'],
      },
      {
        selector: '.spr-support-warning',
        values: ['backgroundColor: var(--spr-support-warning, #F3BF24)'],
      },
      {
        selector: '.spr-support-warning-highlight',
        values: ['backgroundColor: var(--spr-support-warning-highlight, rgba(243, 191, 36, 0.3))'],
      },
      {
        selector: '.spr-clr-blue-highlight',
        values: ['backgroundColor: var(--spr-clr-blue-highlight, #2B3343)'],
      },
      {
        selector: '.spr-tag',
        values: ['backgroundColor: var(--spr-tag, #48484C)'],
      },
      {
        selector: '.spr-tag-01',
        values: ['backgroundColor: var(--spr-tag-01, #48484C)'],
      },
      {
        selector: '.spr-tag-02',
        values: ['backgroundColor: var(--spr-tag-02, rgba(255, 255, 255, 0.1))'],
      },
      {
        selector: '.spr-field',
        values: ['backgroundColor: var(--spr-field, #48484C)'],
      },
      {
        selector: '.spr-popup',
        values: ['backgroundColor: var(--spr-popup, #1C1C1F)'],
      },
      {
        selector: '.spr-overlay',
        values: ['backgroundColor: var(--spr-overlay, rgba(28, 28, 31, 0.85))'],
      },
      {
        selector: '.spr-tooltip-01',
        values: ['backgroundColor: var(--spr-tooltip-01, #FFFFFF)'],
      },
      {
        selector: '.spr-highlight',
        values: ['backgroundColor: var(--spr-highlight, rgba(184, 144, 0, 0.6))'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-notification, #FA6274)'],
      },
      {
        selector: '.spr-interactive-01',
        values: ['backgroundColor: var(--spr-interactive-01, #4B8AFC)'],
      },
      {
        selector: '.spr-interactive-hover',
        values: ['backgroundColor: var(--spr-interactive-hover, #1858CE)'],
      },
      {
        selector: '.spr-interactive-disable',
        values: ['backgroundColor: var(--spr-interactive-disable, rgba(72,72,76,0.8))'],
      },
      {
        selector: '.spr-interactive-02',
        values: ['backgroundColor: var(--spr-interactive-02, #48484C)'],
      },
      {
        selector: '.spr-clr-blue',
        values: ['backgroundColor: var(--spr-clr-blue, #297AB9)'],
      },
      {
        selector: '.spr-clr-green',
        values: ['backgroundColor: var(--spr-clr-green, #097A4B)'],
      },
      {
        selector: '.spr-clr-lavender',
        values: ['backgroundColor: var(--spr-clr-lavender, #9C60FF)'],
      },
      {
        selector: '.spr-clr-orange',
        values: ['backgroundColor: var(--spr-clr-orange, #FF9F21)'],
      },
      {
        selector: '.spr-clr-pink',
        values: ['backgroundColor: var(--spr-clr-pink, #FFA1BE)'],
      },
      {
        selector: '.spr-clr-red',
        values: ['backgroundColor: var(--spr-clr-red, #DB334F)'],
      },
      {
        selector: '.spr-clr-sea',
        values: ['backgroundColor: var(--spr-clr-sea, #00C8FF)'],
      },
      {
        selector: '.spr-clr-teal',
        values: ['backgroundColor: var(--spr-clr-teal, #02D999)'],
      },
      {
        selector: '.spr-clr-yellow',
        values: ['backgroundColor: var(--spr-clr-yellow, #95700D)'],
      },
      {
        selector: '.spr-clr-grey',
        values: ['backgroundColor: var(--spr-clr-grey, #646469)'],
      },
      {
        selector: '.spr-clr-purple',
        values: ['backgroundColor: var(--spr-clr-purple, #763BD2)'],
      },
      {
        selector: '.spr-clr-lt-yellow',
        values: ['backgroundColor: var(--spr-clr-lt-yellow, #846F35)'],
      },
      {
      ...
      },
      {
        ...
        values: ['backgroundColor: var(--spr-secondary-yellow, #8D6F18)'],
      },
      {
        selector: '.spr-secondary-green',
        values: ['backgroundColor: var(--spr-secondary-green, #5F732C)'],
      },
      {
        selector: '.spr-secondary-teal',
        values: ['backgroundColor: var(--spr-secondary-teal, #168380)'],
      },
      {
        selector: '.spr-secondary-lt-pink',
        values: ['backgroundColor: var(--spr-secondary-lt-pink, #956787)'],
      },
      {
        selector: '.spr-secondary-pink',
        values: ['backgroundColor: var(--spr-secondary-pink, #B94055)'],
      },
      {
        selector: '.spr-secondary-maroon',
        values: ['backgroundColor: var(--spr-secondary-maroon, #962F61)'],
      },
      {
        selector: '.spr-secondary-orange',
        values: ['backgroundColor: var(--spr-secondary-orange, #A8623A)'],
      },
      {
        selector: '.nav-ui-01',
        values: ['backgroundColor: var(--nav-ui-01, rgba(44, 44, 47, 0.7))'],
      },
      {
        selector: '.nav-ui-hover-01',
        values: ['backgroundColor: var(--nav-ui-hover-01, rgba(44, 44, 47, 0.9))'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        values: ['fill: var(--spr-icon-01, #F1F1F1)'],
      },
      {
        selector: '.spr-icon-02',
        values: ['fill: var(--spr-icon-02, #AEAEB2)'],
      },
      {
        selector: '.spr-icon-03',
        values: ['fill: var(--spr-icon-03, #AEAEB2)'],
      },
      {
        selector: '.spr-icon-04',
        values: ['fill: var(--spr-icon-04, #4B8AFC)'],
      },
      {
        selector: '.spr-icon-05',
        values: ['fill: var(--spr-icon-05, #1C1C1F)'],
      },
      {
      ...
      },
      {
        ...
        values: ['fill: var(--spr-icon-hover, #FFFFFF)'],
      },
      {
        selector: '.spr-icon-disable',
        values: ['fill: var(--spr-icon-disable, #DBDBDB)'],
      },
      {
      ...
      },
      {
        ...
        values: ['fill: var(--spr-icon-error, #FA6274)'],
      },
      {
        selector: '.nav-icon-01',
        values: ['fill: var(--nav-icon-01, rgba(255, 255, 255, 0.6))'],
      },
      {
        selector: '.nav-icon-focus-01',
        values: ['fill: var(--nav-icon-focus-01, #2E6BD9)'],
      },
    ],
  },
  {
    ...
    rules: [
      {
        ...
        values: ['boxShadow: var(--spr-shadow-01, 0 1px 4px 0 rgba(10,10,20,0.3))'],
      },
      {
        selector: '.spr-shadow-02',
        values: ['boxShadow: var(--spr-shadow-02, 1px 1px 7px rgba(255, 255, 255, 0.1))'],
      },
      {
        selector: '.spr-shadow-03',
        values: ['boxShadow: var(--spr-shadow-03, -2px 5px 12px 0 rgba(10,10,20,0.80))'],
      },
      {
        selector: '.spr-shadow-04',
        values: ['boxShadow: var(--spr-shadow-04, -2px 5px 12px -4px rgba(0,0,0,1.0))'],
      },
      {
        selector: '.spr-shadow-05',
        values: ['boxShadow: var(--spr-shadow-05, 0px 3px 4px 0 rgba(0,0,0,0.2))'],
      },
      {
        selector: '.spr-shadow-06',
        values: ['boxShadow: var(--spr-shadow-06, 0px -3px 4px 0 rgba(0,0,0,0.2))'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      {
        selector: '.outline-01',
        values: ['outlineStyle: solid', 'outlineWidth: 2px', 'outlineColor: #4B8AFC', 'outlineOffset: 2px'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        selector: '.spr-focus-02',
        values: ['outline: var(--spr-focus-02, 1px solid #1c62fd)'],
      },
      {
        selector: '.spr-border-01',
        values: ['borderColor: var(--spr-border-01, #3A3A3E)'],
