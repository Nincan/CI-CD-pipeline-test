export const COUNTRIES = {
  ...
  AQ: { label: 'Antarctica', id: 'AQ', dialCode: '+672' },
  UM: { label: 'United States Minor Outlying Islands', id: 'UM', dialCode: '+1' },
  HM: { label: 'Heard Island and McDonald Islands', id: 'HM', dialCode: '+672' },
  BV: { label: 'Bouvet Island', id: 'BV', dialCode: '+47' },
  DG: { label: 'Diego Garcia', id: 'DG', dialCode: '+246' },
  AC: { label: 'Ascension Island', id: 'AC', dialCode: '+246' },
  AN: { label: 'Netherlands Antilles', id: 'AN', dialCode: '+599' },
  EH: { label: 'Western Sahara', id: 'EH', dialCode: '+212' },
  TF: { label: 'French Southern Territories', id: 'TF', dialCode: '+262' },
  GS: { label: 'South Georgia and the South Sandwich Islands', id: 'GS', dialCode: '+500' },
  CS: { label: 'Serbia and Montenegro', id: 'CS', dialCode: '+381' },
  BQ: { label: 'Bonaire', id: 'BQ', dialCode: '+599' },
  PN: { label: 'Pitcairn', id: 'PN', dialCode: '+64' },
} as const;

export const COUNTRY_SELECT_OPTIONS = Object.values(COUNTRIES);

export const DEFAULT_MAX_DROPDOWN_HEIGHT = '240px';

export const DEFAULT_MAX_DROPDOWN_WIDTH = '240px';

export const ISO_REGEX = /^[a-z]{2}$/i;

export const ISO_TO_FLAG_OFFSET = 127397;
...
export const EMPTY_LIST_HEIGHT = 72;
